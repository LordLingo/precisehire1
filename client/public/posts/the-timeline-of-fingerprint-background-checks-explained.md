...
![Common Scenarios Where Fingerprint Background Checks Are Used](https://precisehire.com/wp-content/uploads/2025/01/Common-Scenarios-Where-Fingerprint-Background-Checks-Are-Used-visual-selection.png)

[Fingerprint background checks](<https://precisehire.com/step-by-step-guide-to-level-1-background-checks/>) are utilized in various sectors, including:
...
![Legal Aspects of Fingerprint Background Checks](https://precisehire.com/wp-content/uploads/2025/01/Legal-Aspects-of-Fingerprint-Background-Checks-visual-selection.png)
...
In the U.S., fingerprint background checks are subject to a number of **federal and state regulations** designed to protect both employers and job applicants.
  ...
  2. **Expungement and Sealing of Records:** Some criminal records, especially older offenses or those resulting in a conviction, can be expunged or sealed under certain conditions. If a record is sealed or expunged, it generally should not appear in a fingerprint background check.
  3. **EEOC Guidelines:** The **Equal Employment Opportunity Commission \(EEOC\)** has guidelines on how employers should use criminal records in employment decisions. Employers should avoid blanket policies that automatically disqualify applicants based on their criminal history and should consider the nature of the crime, its relevance to the job, and how much time has passed since the offense.

#### **FAQs About Fingerprint Background Checks**

  1. **How far back does a fingerprint background check go for government jobs?** Government jobs may require background checks that go back several decades, especially for positions related to national security.
  2. **Can expunged records appear in a fingerprint background check?** Expunged records should not appear in a fingerprint check. However, some agencies may still be able to access sealed or expunged records depending on their jurisdiction.
  3. **What types of crimes are most commonly revealed through fingerprint checks?** Fingerprint background checks can reveal a wide variety of crimes, including felonies, misdemeanors, arrests, and convictions, particularly those related to theft, drug offenses, violent crimes, or fraud.
  4. **How do fingerprint checks differ from name-based background checks?** Fingerprint checks are more accurate, as they rely on biometric data, while name-based checks rely on personal identifiers, which can be prone to errors or fraud.
  5. **Do fingerprint background checks include international criminal records?** In most cases, fingerprint background checks focus on domestic criminal records. International records may require separate checks depending on the specific job or role.
