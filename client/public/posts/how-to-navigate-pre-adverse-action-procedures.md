...
![Pre-Adverse Action and the FCRA: Context and Application](https://precisehire.com/wp-content/uploads/2025/01/Pre-Adverse-Action-and-the-FCRA_-Context-and-Application-visual-selection.png)
...
[Pre-adverse action](<https://www.mycriminalrecords.com/>) notices serve dual purposes:

  1. **Protecting Applicants ’ Rights**: By notifying candidates about potential adverse decisions, employers empower them to respond to or challenge inaccuracies in the report.
  2. **Ensuring Compliance and Reducing Legal Risks** : FCRA violations can result in lawsuits and fines. The pre-adverse action process helps employers demonstrate due diligence and compliance, mitigating the risk of legal repercussions.
...
The employer must inform the applicant in writing of their intent to take adverse action based on the background check. This notice should clearly state that the decision is not final and the applicant has an opportunity to respond.
  2. **Providing a Copy of the Background Check Report**  
A complete copy of the background check or consumer report used in the decision must be included. This allows the applicant to review the information for any inaccuracies or outdated details.
  3. **Including a Summary of Rights Under the FCRA**  
...
The pre-adverse action process plays a significant role in upholding fairness in [employment decisions](<https://precisehire.com/the-ultimate-guide-to-best-background-searches/>). By offering applicants a chance to address potential discrepancies, it ensures that hiring decisions are based on accurate and reliable information.
...
To stay compliant with FCRA rules, employers must:
  ...
  1. Follow a structured pre-adverse action process.
  2. Provide clear and transparent communication to applicants.
  3. Maintain records of all steps taken during the hiring process.
...
![Common Mistakes Employers Make \(and How to Avoid Them\)](https://precisehire.com/wp-content/uploads/2025/01/Common-Mistakes-Employers-Make-and-How-to-Avoid-Them-visual-selection.png)

  1. **Failing to Issue a Pre-Adverse Action Notice**
  ...
  3. **Making the Decision Too Quickly**
...
#### What to Do If You Receive a Pre-Adverse Action Notice
  ...
  2. **Understand Your Rights Under the FCRA**
  ...
  3. **Contact the Background Screening Company**
...
![Legal Aspects of Pre-Adverse Action](https://precisehire.com/wp-content/uploads/2025/01/Legal-Aspects-of-Pre-Adverse-Action-visual-selection.png)
...
###  __What is the difference between pre-adverse action and adverse action?
...
###  __How long does an employer have to wait after sending a pre-adverse action notice?
...
###  __Can a job applicant dispute information after receiving a pre-adverse action notice?
...
###  __Are pre-adverse action notices mandatory for all background checks?
...
###  __What happens if an employer skips the pre-adverse action process?
