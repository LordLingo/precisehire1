...
import { WEEKLY_RESOURCE_MARKDOWN, WEEKLY_RESOURCE_POST as post } from "@/content/weekly_resource_post";
import { resolveAuthor } from "@/content/authors";

export default function BackgroundCheckPricingStaffingAgencies() {
    ...
    <>
      ...
      <article className="container pb-20">
        <div className="mx-auto max-w-4xl prose prose-lg prose-precisehire max-w-none">
          <Streamdown>{WEEKLY_RESOURCE_MARKDOWN}</Streamdown>
        </div>
        <div className="mx-auto max-w-4xl mt-12 rounded-2xl bg-[#0B1F3A] text-white p-6 sm:p-8 flex flex-col sm:flex-row gap-5 sm:items-center">
          <div className="flex-1">
            <p className="text-xs uppercase tracking-[0.16em] font-semibold text-[#E26C72]">Staffing package audit</p>
            <h3 className="mt-2 font-display text-xl sm:text-2xl font-semibold leading-snug">Want pricing built around staffing margins?</h3>
            <p className="mt-2 text-[14.5px] text-white/70 leading-relaxed">We will review your package mix, pass-through fees, ATS workflow, and client billing rules.</p>
          </div>
