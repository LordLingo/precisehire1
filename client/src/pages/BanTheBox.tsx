...
const JURISDICTIONS: Jurisdiction[] = [
  ...
  { name: "Illinois", state: "IL", scope: "state", stage: "Deemed qualified", effective: "Sep 15, 2020" },
  ...
  { name: "Massachusetts", state: "MA", scope: "state", stage: "After interview", effective: "Oct 13, 2018" },
