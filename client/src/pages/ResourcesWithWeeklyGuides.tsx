...
import { BACKGROUND_CHECK_TURNAROUND_TIME_POST } from "@/content/background_check_turnaround_time_post";
import { INTERNATIONAL_BACKGROUND_CHECKS_BUYING_GUIDE_POST } from "@/content/international_background_checks_buying_guide_post";
...
export default function ResourcesWithWeeklyGuides() {
  ...
  const visiblePosts = useMemo(
    () => [
      INTERNATIONAL_BACKGROUND_CHECKS_BUYING_GUIDE_POST,
      BACKGROUND_CHECK_TURNAROUND_TIME_POST,
